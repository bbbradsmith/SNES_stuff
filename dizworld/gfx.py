...
pal_bg = [(0,0,0)] # start with black
pal_bg = make_pal(rgb_img_load("sky.png"),0,0,-1,-1,pal_bg)
pal_bg = make_pal(rgb_img_load("dizworld.png"),0,0,-1,-1,pal_bg)
pal_fg = [(255,0,255)]
pal_fg = make_pal(rgb_img_load("sprites.png"),0,0,-1,-1,pal_fg)

bin_save("bg.pal",snes_pal(pal_bg))
bin_save("fg.pal",snes_pal(pal_fg))

chr_fg = chr(index_img_load("sprites.png",pal_fg))
bin_save("fg.chr",chr_fg);

(chr_sky,nmt_sky) = tilemap(index_img_load("sky.png",pal_bg),0,8,8,2)
bin_save("sky.chr",chr_sky)
bin_save("sky.nmt",nmt_sky)

md7_bg = tilemap(index_img_load("dizworld.png",pal_bg),0,8,8,7)
bin_save("bg.md7",md7_bg)
